...
COPY Star (kepler_id, t_eff, radius) FROM 'data/stars2.csv' CSV;

COPY Planet (kepler_id, koi_name, kepler_name, status, period, radius, t_eq) FROM 'data/planets2.csv' CSV;